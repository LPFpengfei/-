...
public class ShareConfig {
    ...
    public void initSina() {
        ...
        sinaShareContent.setShareContent("手机购物商城,欢迎您！！");
        sinaShareContent.setTitle("刘鹏飞");
    ...
    public void initQQ() {
        ...
        qqShareContent.setShareContent("手机购物商城,欢迎您！！");
        qqShareContent.setTitle("刘鹏飞");
    ...
    public void initQQzone() {
        ...
        qzone.setShareContent("手机购物商城,欢迎您！！");
    ...
    public void initWeixin() {
        ...
        weiXinShareContent.setShareContent("手机购物商城,欢迎您！！");
        weiXinShareContent.setTargetUrl("www.baidu.com");
        weiXinShareContent.setTitle("刘鹏飞");
    ...
    public void initWXCircle() {
        ...
        circleShareContent.setShareContent("手机购物商城,欢迎您！！");
        circleShareContent.setTargetUrl("www.baidu.com");
        circleShareContent.setTitle("刘鹏飞");
